      ...
      <div id='bucket_container'>
        ...
        <div v-if='activetab_2 === 1' class="bucketcontent">
          <div class="ess_bucket">
            <div class="ess_add_list" v-for="esslist in esslists" :key="esslist._id">
              <div class="ess_add_title" style="font-weight:bold;">{{ esslist.category }}</div>
        ...
        <div v-if='activetab_2 === 2' class="bucketcontent">
          <div class="non_bucket">
            <div class="non_add_list" v-for="nonlist in nonlists" :key="nonlist._id">
              <div class="non_add_title" style="font-weight:bold;">{{ nonlist.category }}</div>
...
export default {
  ...
  methods: {
    ...
    load_bucket_must: function () {
      ...
      axios.get('/api/insert_bucket', true)
        .then((response) =>{
          var i = 0
          var j = 0
    ...
    load_bucket_option: function () {
      ...
      axios.get('/api/insert_bucket', false)
        .then((response) => {
          var i = 0
          var j = 0
          console.log('response.data')
